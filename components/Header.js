...
export default function Header (props) {
  return (
    <React.Fragment>
      <header id='header' className={cx(['header rel z10 fix top left right x',
        ...
        <div className='header__inner rel f aic jcb'>
          ...
          <div className='header__right f aic'>
            ...
            <button id='menuToggle' className='header__menu-toggle rel'>
              <span></span>
            </button>
          </div>
        </div>
